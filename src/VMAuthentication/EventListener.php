...
/*
 * VMAuthentication plugin by Zeao, enjoy.
*/
...
class EventListener implements Listener{
	...
	public function onPlayerJoin(PlayerJoinEvent $event){
		if($this->plugin->getConfig()->get("authenticateByLastId") === true and $event->getPlayer()->hasPermission("vmauthentication.lastid")){
	...
	public function onPlayerCommand(PlayerCommandPreprocessEvent $event){
		if(!$this->plugin->isPlayerAuthenticated($event->getPlayer())){
			...
			}elseif(!$event->getPlayer()->hasPermission("vmauthentication.chat")){
				$event->setCancelled(true);
			}
		}
	}
	...
	public function onPlayerMove(PlayerMoveEvent $event){
		if(!$this->plugin->isPlayerAuthenticated($event->getPlayer())){
			if(!$event->getPlayer()->hasPermission("vmauthentication.move")){
				$event->setCancelled(true);
